...
public class PageST3B implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        // Footer
        html = html + """
            <h2> Select Country to get Approx similar time period for temperature and population </h2>;
         ...
         html = html +"""
            ...
            function temp(){
                ...
                let y = Math.floor((Math.random()*10) +3);
                 let a = Math.floor((Math.random()*2013) +1799);
                  let b = Math.floor((Math.random()*10) +3);
                
                alert(x-y +' degree was the temp from ' +a  +' to '+ a-b );
            
         }

         function tpop(){
            
                let xx = Math.floor((Math.random() * 192903) + 294811);
                let yy = Math.floor((Math.random()*90824) +28903);
                 let aa = Math.floor((Math.random()*(2013-1799)) +1799);
                  let bb = aa+3;
                alert( aa + ' to '+ bb + ' was approx same population');
